...
<<<<<<< HEAD
    ...
    msu_test_real_dataset = MSU_dataset(os.path.join(path, 'pr_depth_map/MSU/real/crop_frame/crop_face'), 'test', transform = transform, transform_depth = transform_depth, attack = "real")
    msu_test_print_dataset = MSU_dataset(os.path.join(path, 'pr_depth_map/MSU/attack/crop_frame/crop_face'), 'test', transform = transform, transform_depth = transform_depth, attack = "print")
    msu_test_replay_dataset = MSU_dataset(os.path.join(path, 'pr_depth_map/MSU/attack/crop_frame/crop_face'), 'test', transform = transform, transform_depth = transform_depth, attack = "replay")
    ...
    idiap_test_real_dataset = Idiap_dataset(os.path.join(path, 'pr_depth_map/ReplayAttack/replayattack-test/real/crop_frame/crop_face'), 'test', transform = transform, transform_depth = transform_depth, attack = "real")
    idiap_test_print_fixed_dataset = Idiap_dataset(os.path.join(path, 'pr_depth_map/ReplayAttack/replayattack-test/attack/fixed/crop_frame/crop_face'), 'test', transform = transform, transform_depth = transform_depth, attack = "print")
    idiap_test_replay_fixed_dataset = Idiap_dataset(os.path.join(path, 'pr_depth_map/ReplayAttack/replayattack-test/attack/fixed/crop_frame/crop_face'), 'test', transform = transform, transform_depth = transform_depth, attack = "replay")
    idiap_test_print_hand_dataset = Idiap_dataset(os.path.join(path, 'pr_depth_map/ReplayAttack/replayattack-test/attack/hand/crop_frame/crop_face'), 'test', transform = transform, transform_depth = transform_depth, attack = "print")
    idiap_test_replay_hand_dataset = Idiap_dataset(os.path.join(path, 'pr_depth_map/ReplayAttack/replayattack-test/attack/hand/crop_frame/crop_face'), 'test', transform = transform, transform_depth = transform_depth, attack = "replay")
    ...
    oulu_test_dataset = Oulu_dataset(os.path.join(path, 'pr_depth_map/Oulu_NPU/Test_files/crop_frame/crop_face'), 'test', transform = transform, transform_depth = transform_depth)
