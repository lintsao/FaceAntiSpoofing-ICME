...
def get_args():
    ...
    parser.add_argument('--image_path', type=str, default='./sample_faces/cropped_531652.png',
                        help='Input image path')
    parser.add_argument('--folder_path', type=str, default='./sample_faces',
...
if __name__ == '__main__':
    ...
    for img_path in sorted(images):
        ...
        cv2.imwrite('{}_{}_{}_cam.jpg'.format(name, args.mode, args.method), cam_image)
